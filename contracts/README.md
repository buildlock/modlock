...
These files are the implementation-neutral source of truth for network and portable data. They are design contracts during Phase 0 and become compatibility contracts once a released client consumes them.
